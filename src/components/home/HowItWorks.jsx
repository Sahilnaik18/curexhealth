...
const steps = [
  { step:'01', emoji:'📋', title:'Submit Your Request', desc:'Call, WhatsApp, or fill our form. Tell us your condition and preferred slot — takes 60 seconds.', color:'#0F6CBD', bg:'#E8F3FC', details:['Available 7 days a week','Confirmed in 15 mins','No advance payment'] },
  { step:'02', emoji:'📞', title:'Our Team Contacts You', desc:'A care coordinator calls within 15 minutes, understands your needs & assigns the right professional.', color:'#00B894', bg:'#E0F7F3', details:['Expert matching','Flexible time slots','Same-day available'] },
  { step:'03', emoji:'🏠', title:'Professional Visits Home', desc:'Your certified professional arrives fully equipped, on time — ready to deliver expert care.', color:'#5B4FCF', bg:'#EEF0FD', details:['Clinic-grade equipment','Punctual every time','Verified professional'] },
  { step:'04', emoji:'📊', title:'Care & Follow-up', desc:'Receive expert treatment. Digital reports, follow-up reminders, and ongoing support included.', color:'#E17055', bg:'#FDF0EC', details:['Digital session report','Progress tracking','Follow-up reminders'] },
]
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-5">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center text-2xl flex-shrink-0 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3"
            style={{ background:`linear-gradient(135deg,${step.bg},white)`, border:`2px solid ${step.color}18` }} aria-hidden="true">
            {step.emoji}
          </div>
          <div>
...
export default function HowItWorks() {
  ...
  return (
    <section className="py-20 lg:py-28 bg-[#F8FAFC] relative overflow-hidden" id="how-it-works" aria-label="How it works">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 lg:gap-5 relative">
        ...
        <div className="mt-5 h-1 rounded-full bg-[#E2E8F0] overflow-hidden" aria-hidden="true">
          <motion.div
            ...
            style={{ background:'linear-gradient(90deg,#0F6CBD,#00B894,#5B4FCF,#E17055)' }}
          />
        </div>
